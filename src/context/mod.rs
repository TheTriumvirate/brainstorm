...
#[cfg(not(target_arch = "wasm32"))]
use context::opengl as ContextImpl;
#[cfg(not(target_arch = "wasm32"))]
pub use context::opengl::GLContext as Context;

// TODO: fix web context shit
#[cfg(target_arch = "wasm32")]
use context::webgl as ContextImpl;
#[cfg(target_arch = "wasm32")]
pub use context::webgl::WebGLContext as Context;
